...
Imports VirtualizingSpriteGridDemo.Views
...
Namespace ViewModels
    Public Class ShellViewModel
        ...
        Private Sub PopulateNavItems()
            ...
            _primaryItems.Add(ShellNavigationItem.FromType(Of HorizontalSpriteEntityGridPage)("Shell_HorizontalSpriteEntityGrid".GetLocalized(), Symbol.Document))
            _primaryItems.Add(ShellNavigationItem.FromType(Of VerticalSpriteEntityGridPage)("Shell_VerticalSpriteEntityGrid".GetLocalized(), Symbol.Document))
            _primaryItems.Add(ShellNavigationItem.FromType(Of SpriteEntityGridPage)("Shell_SpriteEntityGrid".GetLocalized(), Symbol.Document))
            _primaryItems.Add(ShellNavigationItem.FromType(Of PerformanceTestsPage)("Shell_PerformanceTests".GetLocalized(), Symbol.Document))
